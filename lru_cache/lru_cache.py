# There is a library called funktools that have the LRUCache
...
class LRUCache:
    ...
    def __init__(self, limit=10):
        ...
        self.storage = {} # or could use self.storage = dict()
    ...
    def get(self, key):
        ...
        if key in self.storage:
            ...
            # find the key in order structure, and move to the front
